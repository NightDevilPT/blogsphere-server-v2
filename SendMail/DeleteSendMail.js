...
exports.DeleteAccountMail = async (clientMail, clientName, deleteLink) => {
	const template = `
    <!DOCTYPE HTML
  PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                            ...
                            <table id="u_content_text_4" style="font-family:'Raleway',sans-serif;" role="presentation"
                                ...
                                <tr>
                                    ...
                                    <div class="v-text-align"
                                        ...
                                        <p style="line-height: 140%; font-size: 14px;"><strong>Click Here to Delete Account :
                                            <span style="color: #3598db; line-height: 19.6px;"><a href='${deleteLink}'>Delete Account</a></span></strong></p>
                                        <p style="line-height: 140%; font-size: 14px;"> </p>
                                        <p style="line-height: 140%; font-size: 14px;"> </p>
                                        <p style="line-height: 140%; font-size: 14px;"><span
	...
	try {
		...
		return {
			success: true,
			error: false,
			message: `Delete Account mail sended to ${clientMail}`,
		};
	} catch (err) {
		return {
			success: false,
